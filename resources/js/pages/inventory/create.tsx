...
export default function CreateInventoryItem({ itemTypes, locations }: Props) {
        ...
        <AppShell>
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Add a new item to your inventory database</p>
                </div>
