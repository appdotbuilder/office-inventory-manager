...
class UpdateInventoryItemRequest extends FormRequest
{
    ...
    {
        return auth()->check() && auth()->user()->canUpdateItems();
    }
    ...
    public function rules(): array
    {
        ...
        return [
            'barcode' => 'required|string|unique:inventory_items,barcode,' . $itemId . '|max:255',
            'serial_number' => 'required|string|unique:inventory_items,serial_number,' . $itemId . '|max:255',
